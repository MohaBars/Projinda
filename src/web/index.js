...
/**
 * Function to reset elements so when user conducts another search, the elements don't overlap
 */
...
/**
 * Function to reset the clouds container to default
 */
function resetClouds() {
    var cloudsContainer = document.querySelector('.clouds-container');
    cloudsContainer.style.display = '';
}

/**
 * Function to reset the sun container to default
 */
function resetSun() {
    var sunContainer = document.querySelector('.sun-container');
...
/**
 * Function to reset the snow container to default
 */
function resetSnow() {
    var snow1 = cloudsContainer.querySelector('.snow1');
    var snow2 = cloudsContainer.querySelector('.snow2');
...
/**
 * Function to reset the rain container to default
 */
function resetRain() {
    var rain1 = cloudsContainer.querySelector('.rain1');
    var rain2 = cloudsContainer.querySelector('.rain2');
