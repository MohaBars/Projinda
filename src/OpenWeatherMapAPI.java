...
public class OpenWeatherMapAPI {
    ...
    public void weatherInformation() {
        ...
        while (true) {
            System.out.print("Enter a city name (or 'quit' to exit): ");
            ...
            String url = "http://api.openweathermap.org/data/2.5/weather?q=" + input + "&appid=" + apiKey;
